...
class Documents {
     ...
     * @return void
     */
    public function add_file_field(): void {
    ...
    public function add_prefix_to_single_folder_title(WP_Term $term, string $taxonomy): WP_Term {
        ...
        if (is_admin() && ($screen_id === 'edit-folder')) {
            return $term;
        }
     ...
     * @return array
     */
    public function sort_folders_by_prefix($defaults, array $taxonomies): array {
     ...
     * @return array
     */
    public function persist_folder_order_in_checklist(array $args, $post_id): array {

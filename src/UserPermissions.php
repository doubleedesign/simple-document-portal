...
class UserPermissions {
	 ...
	 * @return array|string[]
	 */
	final static function get_capability_map(): array {
	 ...
	 * @return void
	 */
	static function map_permissions_to_existing_roles(): void {
	 ...
	 * @return void
	 */
	static function reset_default_capabilities(): void {
		$wp_roles_instance = wp_roles();
	 ...
	 */
	static function get_roles_with_permission(string $capability): array {
		$wp_roles_instance = wp_roles();
	 ...
	 * @return array - associative array of role keys and their details
	 */
	static function get_roles_with_matching_default_permission(string $custom_capability): array {
		$wp_roles_instance = wp_roles();
	 ...
	 * @return string|null
	 */
	static function get_mapped_built_in_capability(string $custom_capability): ?string {
	 ...
	 */
	static function get_roles_currently_in_use(): array {
		$wp_roles_instance = wp_roles();

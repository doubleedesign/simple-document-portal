...
// The PhpStorm Run config "All Browser Tests" is set up to run this file first,
...
it('uses the correct browser test base class', function() {
    expect($this)->toBeInstanceOf(Doubleedesign\SimpleDocumentPortal\Tests\DuskTestCase::class);
});
